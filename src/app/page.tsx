    ...
    <div className="font-[family-name:var(--font-montserrat)] relative">
      ...
      <div className="fixed z-50 top-1/2 right-3 md:right-4 transform -translate-y-1/2 flex flex-col gap-2 animate-fade-in-up" style={{ animationDelay: '1.5s' }}>
        ...
        <div className="social-group relative group">
          <button
            onClick={() => window.open('https://www.facebook.com/share/1XRgrLJZ8N/?mibextid=wwXIfr', '_blank')}
        ...
        <div className="social-group relative group">
          <button
            ...
            className="social-icon social-youtube w-11 h-11 md:w-12 md:h-12 bg-gradient-to-br from-[#FF0000] to-[#CC0000] rounded-xl shadow-lg transition-all duration-300 flex items-center justify-center opacity-50 cursor-not-allowed relative overflow-hidden"
            aria-label="YouTube - Not Available"
            disabled
          >
            <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        <div className="social-group relative group">
          <button
            ...
            className="social-icon social-whatsapp w-11 h-11 md:w-12 md:h-12 bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group-hover:scale-110 group-hover:-translate-y-1 relative overflow-hidden"
            aria-label="WhatsApp"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="white" className="relative z-10 transition-transform duration-300 group-hover:scale-110">
        ...
        <div className="social-group relative group">
          <button
            onClick={(e) => e.preventDefault()}
            className="social-icon social-linkedin w-11 h-11 md:w-12 md:h-12 bg-gradient-to-br from-[#0077B5] to-[#005885] rounded-xl shadow-lg transition-all duration-300 flex items-center justify-center opacity-50 cursor-not-allowed relative overflow-hidden"
